...
<head>
    <meta charset="UTF-8">
    <title>Laporan Transaksi - Jayusman Mart</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .summary-item .val { font-size: 16px; font-weight: bold; color: #1a3c5e; }
...
<div class="header">
    ...
    <p>Jayusman Mart &mdash; {{ $cabang_filter ?? 'Semua Cabang' }}</p>
    <p>Periode: {{ $periode }}</p>
</div>
...
<div class="info-box">
    <table>
        ...
        <tr>
            <td>Cabang</td>
            <td>: {{ $cabang_filter ?? 'Semua Cabang' }}</td>
            <td>Total Data</td>
...
<table style="width:100%; margin-bottom: 16px; border-collapse: separate; border-spacing: 8px 0;">
    <tr>
        <td style="background:#eafaf1; border:1px solid #27ae60; border-radius:6px; padding:10px; text-align:center; width:33%">
        ...
        <td style="background:#eaf4ff; border:1px solid #2980b9; border-radius:6px; padding:10px; text-align:center; width:33%">
        ...
        <td style="background:#eef0f7; border:1px solid #1a3c5e; border-radius:6px; padding:10px; text-align:center; width:33%">
...
<div class="ttd">
    ...
    <p style="color:#888;">{{ ucfirst(str_replace('_',' ', auth()->user()->role)) }}</p>
</div>
