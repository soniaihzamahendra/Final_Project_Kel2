    ...
    <div class="card-body">
        <div class="row mb-4">
            <div class="col-md-6">
                <table class="table table-borderless table-sm">
                    <tr><td>No Transaksi</td><td>: <code>{{ $transaksi->no_transaksi }}</code></td></tr>
                    <tr><td>Cabang</td><td>: {{ $transaksi->cabang->nama_cabang }}</td></tr>
                    <tr><td>Kasir</td><td>: {{ $transaksi->user->name }}</td></tr>
                    <tr><td>Jenis</td>
                        <td>: <span class="badge {{ $transaksi->jenis === 'penjualan' ? 'bg-success' : 'bg-info' }}">
                            {{ ucfirst($transaksi->jenis) }}</span>
                        </td>
                    </tr>
        ...
        <table class="table table-bordered">
            <thead class="table-dark">
                <tr><th>#</th><th>Barang</th><th>Harga Satuan</th><th>Jumlah</th><th>Subtotal</th></tr>
            </thead>
            <tbody>
